...
public class GetCameraSnapshot extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		for (Entity result : pq.asIterable()) {
			if (counter == size - 1) {
				String snapshot = (String) result.getProperty(CameraEntity.snapshot);
				HashMap<String,String> rsp = new HashMap<String,String>();
				rsp.put(CameraEntity.snapshot, snapshot);
